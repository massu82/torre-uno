            ...
            <div class="row">
                ...
                <div class="col-md-6 animate-box" data-animate-effect="fadeInUp">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Bajos costos de mantenimiento y servicios por ser operado por Banyan
                            Tree
                        </li>
                        <li class="list-group-item">Servicio hotelero</li>
                        <li class="list-group-item">Acceso a todas las amenidades del resort Banyan Tree Cabo Marqués*
                        </li>
